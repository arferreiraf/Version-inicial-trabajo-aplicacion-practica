...
INSERT INTO `usuario` (`idUsuario`, `userName`, `contrasena`, `privilegios`,estado) VALUES
(1, 'jaime1', '1234', 1,1),
(3, 'alvaro', '1234', 2,1),
(4, 'ss', 'sw21', 2,2),
(5, 'camila', '3214', 1,2),
...
--
ALTER TABLE `usuario`
  ADD CONSTRAINT `fk_user_estado` FOREIGN KEY (`estado`) REFERENCES `estados` (`idEstado`);
